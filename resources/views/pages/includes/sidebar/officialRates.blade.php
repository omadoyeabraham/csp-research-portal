			...
			<table class="table table-striped text-center">
				<tbody>
					<tr>
						...
						<td class="gainers-losers-price text-right">{{ $exchangeRate->ngn_usd_official or '-' }}</td> 
					</tr>
					<tr>
						<td class="gainers-losers-stock text-left"> NGN/GBP </td>  
						<td class="gainers-losers-price text-right">{{ $exchangeRate->ngn_gbp_official or '-' }}</td> 
					</tr>
					<tr>
						<td class="gainers-losers-stock text-left"> NGN/EUR </td>  
						<td class="gainers-losers-price text-right">{{ $exchangeRate->ngn_eur_official or '-' }}</td> 
					</tr>
